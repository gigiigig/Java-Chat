...
//    public void writeAll(String line) {
//        //scrivo sulla chat del server
//        writeToChatText("write all : " + line);
//        log.debug("write all : " + line);
//
//        line = line + "\n";
//
...
//                        log.debug("write to " + client.getNick() + " : " + line);
//                        outputStream.write(line.getBytes(Util.DEFAULTENCODING));
//                    }
//
...
//                sw.writeAll((COMMAND + Command.REMOVEUSER + toRemove.getNick()));
//            }
//        }
//
//    }
//
//    public void writeToClient(String nick, String line) {
//        if (!line.startsWith("<")) {
//            writeToChatText("write to \"" + nick + " : " + line);
//            log.debug("write to \"" + nick + " : " + line);
//            line = line + "\n";
//        }
//
//
...
//                    //comunico a tutti di eliminare l'utente
//                    ServerWriter sw = new ServerWriter(ccv);
//                    sw.writeAll(COMMAND + Command.REMOVEUSER + client.getNick());
//                    log.error(ex);
//                } catch (Exception ex) {
//                    log.warn(ex);
//                    log.debug("Resend message : " + line + " to client " + nick);
//                    writeToClient(nick, line);
//                }
//            }
//        }
//    }
