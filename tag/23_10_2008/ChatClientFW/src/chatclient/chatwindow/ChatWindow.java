...
public class ChatWindow extends javax.swing.JFrame {
    ...
    EmoticonsManger emoctionsManger;
...
// TODO add your handling code here:
    ...
    public void invia() {
        ...
        log.debug("invia");
        String newText = getInputText().getText();
        ...
        if (newText != null && !newText.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "<html><font color=blue>Il testp da inviare non può essere vuoto<html>", "Attenzione", JOptionPane.WARNING_MESSAGE);
        }
    }
...
//            doc.insertString(doc.getLength(), message + "\n", doc.getStyle("regular"));
    ...
    public void showEmotionsPanel() {
        ...
        if (emotionsPanel !=
            ...
            emotionsPanel = new JDialog(this,
                    false);
...
//        NwFontChooserS.showDialog(this, "test", font);
    ...
    public void refreshInputTextFont() {
        ...
        inputText.getStyledDocument().setLogicalStyle(0, def);
