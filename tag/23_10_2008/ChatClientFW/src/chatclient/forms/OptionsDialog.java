...
public class OptionsDialog extends javax.swing.JDialog {
    ...
    public OptionsDialog(java.awt.Frame parent, boolean modal) {
        ...
        if (properties != null) {
            ...
            String porta = properties.getProperty(Util.PORT);
            String ip = properties.getProperty(Util.IP);
            String nick = properties.getProperty(Util.NICK);
            String downloadFolder = properties.getProperty(Util.DOWNLOAD_FOLDER);
            String themeFolder = properties.getProperty(Util.THEME_FOLDER);
            if (!porta.equals("")) {
            ...
            if (themeFolder == null || themeFolder.equals("")) {
                themeFolder = Util.DEFAULT_THEME_FOLDER;
            }
    ...
    public void saveProperties() {
        ...
        properties.setProperty(Util.PORT, portaText.getText());
        properties.setProperty(Util.IP, ipText.getText());
        properties.setProperty(Util.NICK, nickText.getText());
        properties.setProperty(Util.DOWNLOAD_FOLDER, downloadFolderText.getText());
        properties.setProperty(Util.THEME_FOLDER, themeFolderText.getText());
...
//        ccv.setNick(nickText.getText());
        ...
        ccv.getHelper().setTheme(ThemeManager.loadTheme(properties.getProperty(Util.THEME_FOLDER)));
