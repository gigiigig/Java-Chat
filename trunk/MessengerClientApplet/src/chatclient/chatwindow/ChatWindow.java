...
//    
        SelectClientsToAdd scta = new SelectClientsToAdd(this, ccv);
...
class MainPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        try {
            ...
            ImageIcon icon = (ccv).getHelper().getTheme().get(ThemeManager.CHAT_BACKGROUND);
