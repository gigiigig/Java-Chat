...
public class Launcher {
    ...
    private static String facebookPostMethod(String host, String urlPostfix, List<NameValuePair> nvps) {
        log.debug("@executing facebookPostMethod():" + host + urlPostfix);
    ...
    private static String facebookGetMethod(String url) {
        log.debug("@executing facebookGetMethod():" + url);
        String responseStr = null;
        ...
        try {
            ...
            log.debug("facebookGetMethod: " + response.getStatusLine());
            if (entity != null) {
                responseStr = EntityUtils.toString(entity);
                entity.consumeContent();
            }
