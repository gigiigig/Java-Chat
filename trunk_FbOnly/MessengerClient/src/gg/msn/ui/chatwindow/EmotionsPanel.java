...
//    static final int WINDOWY = 26;
    ...
    public static final int TRASLAZIONEIMG = (int) (5 * SCALEFACTOR);
...
//        ImageIcon icon = new ImageIcon(getClass().getResource("images/tray.png"));
        ...
        if (selected != null) {
            ...
            if (selectedPosition < emotions.size() && selectedPosition != lastPosition) {
                ...
                if (!selectedEmotion.getName().equals("")) {
                    setToolTipText("<html>" + selectedEmotion.getName() + "<br><p align=\"center\">" + selectedEmotion.getShortcut() + "</p></html>");
                } else {
                    setToolTipText("<html><p align=\"center\">" + selectedEmotion.getShortcut() + "</p></html>");
                }
            ...
            } else if (selectedPosition == lastPosition + 1) {
                setToolTipText("<html><p align=\"center\"> Apri<br>Emoticons Manager </p></html>");
            }
        }
        //disegnno  emotion
        ...
        ImageIcon manage = new ImageIcon(this.getClass().getResource("resources/emoManager.png"));
        log.trace("remove : " + plus);
    ...
    public void refreshNUMIMGY() {
        if (fullView) {
            NUMIMGY = (emotions.size() + 2) / NUMIMGX;
            int mod = (emotions.size() + 2) % NUMIMGX;
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (positionOnList < lastPosition) {
            ...
            if (panel.isFullView()) {
                ...
                int totimgY = (panel.getEmotions().size() + 2) / EmotionsPanel.NUMIMGX;
                int mod = (panel.getEmotions().size() + 2) % EmotionsPanel.NUMIMGX;
                log.debug("modulo : " + mod);
                if (mod != 0) {
