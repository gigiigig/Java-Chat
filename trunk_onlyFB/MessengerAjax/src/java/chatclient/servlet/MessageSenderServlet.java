...
public class MessageSenderServlet extends HttpServlet {
    ...
    private Log log = LogFactory.getLog(MessageSenderServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("receiver [" + nick + "]");
        String text = request.getParameter("text");
        Socket socket = null;
        try {
            socket = (Socket) request.getSession().getAttribute("socket");
        ...
        //paramtri
        MessageManger.addParameter(message, "text", text);
        MessageManger.directWriteMessage(message, socket.getOutputStream());
    }
